...
export const SERVICES = [
  { name: 'לק ג׳ל במבנה אנטומי + מניקור', price: 100, highlighted: true },
  { name: 'תיקון ציפורן', price: 5, highlighted: false },
  { name: 'מניקור יסודי', price: 50, highlighted: false },
  { name: 'הסרת לק ג׳ל (לא כולל מניקור)', price: 30, highlighted: false },
]
