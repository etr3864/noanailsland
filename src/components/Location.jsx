    ...
    <section id="location" className="relative px-5 py-12 section-location bg-dots">
      ...
      >
        ...
        <a
          ...
          className="inline-flex items-center gap-2 bg-beige/10 hover:bg-beige/15 transition-colors text-beige px-5 py-2.5 rounded-full text-sm font-bold animate-pulse-gold"
        >
